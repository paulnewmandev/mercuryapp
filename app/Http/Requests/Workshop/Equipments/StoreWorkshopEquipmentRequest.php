...
class StoreWorkshopEquipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'identifier' => [
                ...
                'string',
                'max:255',
                Rule::unique('workshop_equipments', 'identifier')->where(function ($query) use ($companyId): void {
                    if ($companyId) {
                        $query->where('company_id', $companyId);
                    }
                }),
    ...
    public function messages(): array
    {
        return [
            ...
            'model_id.required' => gettext('Debes seleccionar un modelo.'),
            'identifier.required' => gettext('El identificador es obligatorio.'),
        ];
    }
}
