...
class UpdateReceivableCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $category = $this->route('receivableCategory');
        $categoryId = $category instanceof ReceivableCategory ? $category->getKey() : $category;
