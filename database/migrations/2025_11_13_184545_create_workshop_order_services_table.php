...
return new class extends Migration
{
    ...
    {
        Schema::create('workshop_order_services', function (Blueprint $table): void {
            ...
            $table->index(['order_id', 'status'], 'workshop_order_services_order_status_index');
            $table->index(['service_id'], 'workshop_order_services_service_index');
        });
    }
