<x-layouts.dashboard-layout :meta="$meta ?? []">
    <x-ui.breadcrumb :title="gettext('Marcas de taller')" :items="$breadcrumbItems" />
    ...
    <section
        ...
        data-workshop-brands-root
        data-workshop-brands-store-url="{{ route('taller.marcas.store') }}"
        data-workshop-brands-base-url="{{ url('workshop/brands') }}"
        data-workshop-brands-table-id="workshop-brands-table"
    >
        <x-ui.data-table
            tableId="workshop-brands-table"
            apiUrl="{{ route('taller.marcas.data') }}"
            :columns="$columns"
        ...
        >
            <x-slot:headerActions>
                <button
                    ...
                    data-workshop-brand-action="create"
                >
        ...
        <div
            ...
            data-workshop-brand-modal="form"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white" data-workshop-brand-modal-title></h3>
                        <button
                            type="button"
                            ...
                            data-workshop-brand-modal-close
                    ...
                    <form data-workshop-brand-form class="space-y-6 px-6 py-6" novalidate>
                        <input type="hidden" data-workshop-brand-input="id">
                        <input type="hidden" data-workshop-brand-input="status" value="A">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input
                                    type="text"
                                    data-workshop-brand-input="name"
                                    ...
                                    required
                                >
                                <p data-workshop-brand-error="name" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    data-workshop-brand-input="description"
                                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-gray-700 dark:bg-slate-900 dark:text-white"
                                    rows="4"
                                    maxlength="1000"
                                ></textarea>
                                <p data-workshop-brand-error="description" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <button
                                ...
                                data-workshop-brand-submit
                            >
                                <span data-workshop-brand-submit-label>{{ gettext('Guardar') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-workshop-brand-modal="view"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white">{{ gettext('Detalle de la marca') }}</h3>
                        <button
                            type="button"
                            class="absolute right-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-slate-800"
                            data-workshop-brand-modal-close
                    ...
                    <div class="space-y-4 px-6 py-6" data-workshop-brand-view>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-workshop-brand-view-field="name"></p>
                                </div>
                            </div>
                        </div>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-workshop-brand-view-field="description"></p>
                                </div>
                            </div>
                        </div>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-workshop-brand-view-field="status_label"></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-workshop-brand-modal="delete"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-md">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white">{{ gettext('Eliminar marca') }}</h3>
                        <button
                            type="button"
                            class="absolute right-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-slate-800"
                            data-workshop-brand-modal-close
                    ...
                    <div class="space-y-4 px-6 py-6">
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            {{ gettext('¿Estás seguro de eliminar la marca? Esta acción no se puede deshacer.') }}
                        </p>
                        <div class="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
                            ...
                            <span>{{ gettext('Se eliminará:') }} <strong data-workshop-brand-delete-name></strong></span>
                        </div>
                    </div>
                    <div class="flex items-center justify-end gap-3 border-t border-gray-200 px-6 py-4 dark:border-gray-800">
                        ...
                        <button
                            ...
                            data-workshop-brand-delete-confirm
                        >
                            {{ gettext('Eliminar') }}
                        </button>
                    </div>
