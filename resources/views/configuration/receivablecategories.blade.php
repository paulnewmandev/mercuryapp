<x-layouts.dashboard-layout :meta="$meta ?? []">
    ...
    <section
        ...
        data-receivable-categories-root
        data-receivable-categories-store-url="{{ route('configuration.receivable_categories.store') }}"
        data-receivable-categories-base-url="{{ url('configuration/accounts-receivable') }}"
        data-receivable-categories-table-id="receivable-categories-table"
    >
        <x-ui.data-table
            tableId="receivable-categories-table"
            apiUrl="{{ route('configuration.receivable_categories.data') }}"
            :columns="$columns"
        ...
        >
            <x-slot:headerActions>
                <button
                    ...
                    data-receivable-category-action="create"
                >
        ...
        <div
            ...
            data-receivable-category-modal="form"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-2xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white" data-receivable-category-modal-title></h3>
                        <button
                            type="button"
                            ...
                            data-receivable-category-modal-close
                    ...
                    <form data-receivable-category-form class="space-y-6 px-6 py-6" novalidate>
                        <input type="hidden" data-receivable-category-input="id">
                        <input type="hidden" data-receivable-category-input="status" value="A">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input
                                    type="text"
                                    data-receivable-category-input="code"
                                    ...
                                    required
                                >
                                <p data-receivable-category-error="code" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            <div>
                                ...
                                <input
                                    type="text"
                                    data-receivable-category-input="name"
                                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-gray-700 dark:bg-slate-900 dark:text-white"
                                    maxlength="255"
                                    required
                                >
                                <p data-receivable-category-error="name" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            <div>
                                ...
                                <textarea
                                    rows="4"
                                    data-receivable-category-input="description"
                                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-gray-700 dark:bg-slate-900 dark:text-white"
                                ></textarea>
                                <p data-receivable-category-error="description" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <button
                                ...
                                data-receivable-category-submit
                            >
                                <span data-receivable-category-submit-label>{{ gettext('Guardar') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-receivable-category-modal="view"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-2xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6" data-receivable-category-view>
                        <div class="space-y-4">
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-receivable-category-view-field="code"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-receivable-category-view-field="name"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 whitespace-pre-line text-sm text-gray-900 dark:text-white" data-receivable-category-view-field="description"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-receivable-category-modal="delete"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-lg">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6">
                        ...
                        <div class="rounded-xl bg-gray-100 px-4 py-3 text-sm text-gray-700 dark:bg-slate-800 dark:text-gray-200" data-receivable-category-delete-name></div>
                    </div>
                    <div class="flex items-center justify-end gap-3 border-t border-gray-200 px-6 py-4 dark:border-gray-800">
                        ...
                        <button
                            ...
                            data-receivable-category-delete-confirm
                        >
                            {{ gettext('Eliminar') }}
                        </button>
                    </div>
