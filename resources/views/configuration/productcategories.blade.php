<x-layouts.dashboard-layout :meta="$meta ?? []">
    <x-ui.breadcrumb :title="gettext('Categorías de productos')" :items="$breadcrumbItems" />
    ...
    <section
        ...
        data-product-categories-table-id="product-categories-table"
    ...
    >
        <x-ui.data-table
            ...
            apiUrl="{{ route('configuration.product_categories.data', ['parent_scope' => 'root']) }}"
            :columns="$columns"
                ...
                <div class="relative w-full overflow-visible rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <form data-product-category-form class="space-y-6 px-6 py-6" novalidate>
                        ...
                        <div class="space-y-5">
                            ...
                            <div data-product-category-parent-wrapper class="hidden">
