<x-layouts.dashboard-layout :meta="$meta ?? []">
    <x-ui.breadcrumb :title="gettext('Tarjetas')" :items="$breadcrumbItems" />
    ...
    <section
        ...
        data-cards-root
        data-cards-store-url="{{ route('configuration.cards.store') }}"
        data-cards-base-url="{{ url('configuration/cards') }}"
        data-cards-table-id="cards-table"
    >
        <x-ui.data-table
            tableId="cards-table"
            apiUrl="{{ route('configuration.cards.data') }}"
            :columns="$columns"
            ...
            <div class="mx-4 my-8 w-full max-w-2xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white" data-card-modal-title></h3>
                        <button
                            type="button"
                    ...
                    <form data-card-form class="space-y-6 px-6 py-6" novalidate>
                        <input type="hidden" data-card-input="id">
                        <input type="hidden" data-card-input="status" value="A">
                        ...
                        <div class="space-y-5">
                            <div class="sm:col-span-2">
                                ...
                                <input
                                    ...
                                    required
                                >
                                <p data-card-error="name" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            <div>
                                ...
                                <textarea
                                    rows="4"
                                    data-card-input="description"
                                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-gray-700 dark:bg-slate-900 dark:text-white"
                                ></textarea>
                                <p data-card-error="description" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <button
                                ...
                                data-card-submit
                            >
                                <span data-card-submit-label>{{ gettext('Guardar') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        >
            <div class="mx-4 my-8 w-full max-w-2xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6" data-card-view>
                        <div class="space-y-4">
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-card-view-field="name"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 whitespace-pre-line text-sm text-gray-900 dark:text-white" data-card-view-field="description"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="mx-4 my-8 w-full max-w-lg">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6">
                        ...
                        <div class="rounded-xl bg-gray-100 px-4 py-3 text-sm text-gray-700 dark:bg-slate-800 dark:text-gray-200" data-card-delete-name></div>
                    </div>
