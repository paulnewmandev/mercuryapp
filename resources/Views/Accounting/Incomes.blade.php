<x-layouts.dashboard-layout :meta="$meta ?? []">
    <x-ui.breadcrumb :title="gettext('Ingresos')" :items="$breadcrumbItems" />
    ...
    <section
        ...
        data-incomes-root
        data-incomes-store-url="{{ route('accounting.incomes.store') }}"
        data-incomes-base-url="{{ url('accounting/incomes') }}"
        data-incomes-table-id="incomes-table"
        data-incomes-types='@json($incomeTypes)'
        data-incomes-options-url="{{ route('accounting.incomes.options') }}"
    >
        <x-ui.data-table
            tableId="incomes-table"
            apiUrl="{{ route('accounting.incomes.data') }}"
            :columns="$columns"
            ...
            <div class="mx-4 my-8 w-full max-w-3xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white" data-income-modal-title></h3>
                        <button
                            type="button"
                    ...
                    <form data-income-form class="space-y-6 px-6 py-6" novalidate>
                        <input type="hidden" data-income-input="id">
                        <input type="hidden" data-income-input="status" value="A">
                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            <div class="md:col-span-2">
                                ...
                                <div
                                    class="relative"
                                    data-select
                                    data-select-name="income_type_id"
                                    data-select-invalid="false"
                                >
                                    <input type="hidden" data-income-input="income_type_id" value="">
                                    <button
                                        type="button"
                                    ...
                                    <div
                                        ...
                                        hidden
                                    >
                                        <div class="max-h-60 overflow-y-auto py-2" data-income-type-options></div>
                                    </div>
                                </div>
                                <p data-income-error="income_type_id" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    type="date"
                                    data-income-input="movement_date"
                                    ...
                                    required
                                >
                                <p data-income-error="movement_date" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        required
                                    >
                                    <span class="pointer-events-none absolute inset-y-0 right-4 flex items-center text-xs font-semibold text-gray-500 dark:text-gray-400" data-income-amount-currency>USD</span>
                                </div>
                                <p data-income-error="amount" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input
                                    type="text"
                                    data-income-input="concept"
                                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-gray-700 dark:bg-slate-900 dark:text-white"
                                    maxlength="255"
                                    required
                                >
                                <p data-income-error="concept" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input
                                    type="text"
                                    data-income-input="reference"
                                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-gray-700 dark:bg-slate-900 dark:text-white"
                                    maxlength="100"
                                >
                                <p data-income-error="reference" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                ></textarea>
                                <p data-income-error="description" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <button
                                ...
                                data-income-submit
                            >
                                <span data-income-submit-label>{{ gettext('Guardar') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        >
            <div class="mx-4 my-8 w-full max-w-3xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white">{{ gettext('Detalle del ingreso') }}</h3>
                        <button
                            type="button"
                            class="absolute right-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-slate-800"
                            data-income-modal-close
                    ...
                    <div class="space-y-4 px-6 py-6" data-income-view>
                            ...
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-income-view-field="income_type_name">-</p>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-income-view-field="movement_date_formatted">-</p>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-income-view-field="amount_formatted">-</p>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-income-view-field="reference">-</p>
                                    </div>
                                </div>
                            </div>
                            <div class="sm:col-span-2 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-income-view-field="concept">-</p>
                                    </div>
                                </div>
                            </div>
                            <div class="sm:col-span-2 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white" data-income-view-field="description">-</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        >
            <div class="mx-4 my-8 w-full max-w-md">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white">{{ gettext('Eliminar ingreso') }}</h3>
                        <button
                            type="button"
                            class="absolute right-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-slate-800"
                            data-income-modal-close
                    ...
                    <div class="space-y-4 px-6 py-6">
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            {{ gettext('¿Estás seguro de eliminar el ingreso seleccionado? Esta acción no se puede deshacer.') }}
                        </p>
                        <div class="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
                            ...
                            <span>{{ gettext('Se eliminará:') }} <strong data-income-delete-concept></strong></span>
                        </div>
                    </div>
