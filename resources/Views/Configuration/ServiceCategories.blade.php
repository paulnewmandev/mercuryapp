<x-layouts.dashboard-layout :meta="$meta ?? []">
    <x-ui.breadcrumb :title="gettext('Categorías de servicios')" :items="$breadcrumbItems" />
    ...
    <section
        ...
        data-service-categories-root
        data-service-categories-store-url="{{ route('configuration.service_categories.store') }}"
        data-service-categories-base-url="{{ url('configuration/service-categories') }}"
        data-service-categories-table-id="service-categories-table"
    >
        <x-ui.data-table
            tableId="service-categories-table"
            apiUrl="{{ route('configuration.service_categories.data') }}"
            :columns="$columns"
        ...
        >
            <x-slot:headerActions>
                <button
                    ...
                    data-service-category-action="create"
                >
        ...
        <div
            ...
            data-service-category-modal="form"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white" data-service-category-modal-title></h3>
                        <button
                            type="button"
                            ...
                            data-service-category-modal-close
                    ...
                    <form data-service-category-form class="space-y-6 px-6 py-6" novalidate>
                        <input type="hidden" data-service-category-input="id">
                        <input type="hidden" data-service-category-input="status" value="A">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input
                                    type="text"
                                    data-service-category-input="name"
                                    ...
                                    required
                                >
                                <p data-service-category-error="name" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <button
                                ...
                                data-service-category-submit
                            >
                                <span data-service-category-submit-label>{{ gettext('Guardar') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-service-category-modal="view"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6" data-service-category-view>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-service-category-view-field="name"></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-service-category-modal="delete"
            role="dialog"
            aria-modal="true"
        >
                ...
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6">
                        ...
                        <div class="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
                            ...
                            <span>{{ gettext('Se eliminará:') }} <strong data-service-category-delete-name></strong></span>
                        </div>
                    </div>
                    <div class="flex items-center justify-end gap-3 border-t border-gray-200 px-6 py-4 dark:border-gray-800">
                        ...
                        <button
                            ...
                            data-service-category-delete-confirm
                        >
                            {{ gettext('Eliminar') }}
                        </button>
                    </div>
