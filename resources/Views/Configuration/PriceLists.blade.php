<x-layouts.dashboard-layout :meta="$meta ?? []">
    <x-ui.breadcrumb :title="gettext('Listas de precios')" :items="$breadcrumbItems" />
    ...
    <section
        ...
        data-price-lists-root
        data-price-lists-store-url="{{ route('configuration.price_lists.store') }}"
        data-price-lists-base-url="{{ url('configuration/price-lists') }}"
        data-price-lists-table-id="price-lists-table"
    >
        <x-ui.data-table
            tableId="price-lists-table"
            apiUrl="{{ route('configuration.price_lists.data') }}"
            :columns="$columns"
            ...
            <div class="mx-4 my-8 w-full max-w-2xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white" data-price-list-modal-title></h3>
                        <button
                            type="button"
                    ...
                    <form data-price-list-form class="space-y-6 px-6 py-6" novalidate>
                        <input type="hidden" data-price-list-input="id">
                        <input type="hidden" data-price-list-input="status" value="A">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                >
                                <p data-price-list-error="name" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            <div>
                                ...
                                <textarea
                                    data-price-list-input="description"
                                ...
                                ></textarea>
                                <p data-price-list-error="description" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <button
                                ...
                                data-price-list-submit
                            >
                                <span data-price-list-submit-label>{{ gettext('Guardar') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        >
            <div class="mx-4 my-8 w-full max-w-2xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6" data-price-list-view>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-price-list-view-field="name"></p>
                                </div>
                            </div>
                        </div>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-price-list-view-field="description"></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        >
            <div class="mx-4 my-8 w-full max-w-md">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white">{{ gettext('Eliminar lista de precios') }}</h3>
                        <button
                            type="button"
                            class="absolute right-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-slate-800"
                            data-price-list-modal-close
                    ...
                    <div class="space-y-4 px-6 py-6">
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            {{ gettext('¿Estás seguro de eliminar la lista de precios? Esta acción no se puede deshacer.') }}
                        </p>
                        <div class="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
                            ...
                            <span>{{ gettext('Se eliminará:') }} <strong data-price-list-delete-name></strong></span>
                        </div>
                    </div>
                    <div class="flex items-center justify-end gap-3 border-t border-gray-200 px-6 py-4 dark:border-gray-800">
                        ...
                        <button
                            ...
                            data-price-list-delete-confirm
                        >
                            {{ gettext('Eliminar') }}
                        </button>
                    </div>
