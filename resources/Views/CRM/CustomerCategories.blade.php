<x-layouts.dashboard-layout :meta="$meta ?? []">
    <x-ui.breadcrumb :title="gettext('Categorías de clientes')" :items="$breadcrumbItems" />
    ...
    <section
        ...
        data-customer-categories-root
        data-customer-categories-store-url="{{ route('clientes.categorias.store') }}"
        data-customer-categories-base-url="{{ url('customers/categories') }}"
        data-customer-categories-table-id="customer-categories-table"
    >
        <x-ui.data-table
            tableId="customer-categories-table"
            apiUrl="{{ route('clientes.categorias.data') }}"
            :columns="$columns"
        ...
        >
            <x-slot:headerActions>
                <button
                    ...
                    data-customer-category-action="create"
                >
        ...
        <div
            ...
            data-customer-category-modal="form"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-2xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white" data-customer-category-modal-title></h3>
                        <button
                            type="button"
                            ...
                            data-customer-category-modal-close
                    ...
                    <form data-customer-category-form class="space-y-6 px-6 py-6" novalidate>
                        <input type="hidden" data-customer-category-input="id">
                        <input type="hidden" data-customer-category-input="status" value="A">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input
                                    type="text"
                                    data-customer-category-input="name"
                                    ...
                                    required
                                >
                                <p data-customer-category-error="name" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                            <div>
                                ...
                                <textarea
                                    data-customer-category-input="description"
                                    ...
                                    maxlength="255"
                                ></textarea>
                                <p data-customer-category-error="description" class="mt-1 text-xs text-rose-500"></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                            ...
                            <button
                                ...
                                data-customer-category-submit
                            >
                                <span data-customer-category-submit-label>{{ gettext('Guardar') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-customer-category-modal="view"
            role="dialog"
            aria-modal="true"
        >
            <div class="mx-4 my-8 w-full max-w-xl">
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    <div class="relative border-b border-gray-200 px-6 py-4 text-center dark:border-gray-800">
                        <h3 class="text-base font-medium text-gray-900 dark:text-white">{{ gettext('Detalle de la categoría') }}</h3>
                        <button
                            type="button"
                            class="absolute right-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-slate-800"
                            data-customer-category-modal-close
                    ...
                    <div class="space-y-4 px-6 py-6" data-customer-category-view>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-customer-category-view-field="name"></p>
                                </div>
                            </div>
                        </div>
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-slate-900/60">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white" data-customer-category-view-field="description"></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div
            class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm"
            data-customer-category-modal="delete"
            role="dialog"
            aria-modal="true"
        >
                ...
                <div class="relative w-full overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-slate-900">
                    ...
                    <div class="space-y-4 px-6 py-6">
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            {{ gettext('¿Estás seguro de eliminar esta categoría? Esta acción no se puede deshacer.') }}
                        </p>
                        <div class="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
                            ...
                            <span>{{ gettext('Se eliminará:') }} <strong data-customer-category-delete-name></strong></span>
                        </div>
                    </div>
                    <div class="flex items-center justify-end gap-3 border-t border-gray-200 px-6 py-4 dark:border-gray-800">
                        ...
                        <button
                            ...
                            data-customer-category-delete-confirm
                        >
                            {{ gettext('Eliminar') }}
                        </button>
                    </div>
